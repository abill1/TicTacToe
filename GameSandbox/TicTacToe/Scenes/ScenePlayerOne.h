...
namespace ABFramework
{
	...
	private:
		...
		const AssetDef defaultTexture = { "DefaultTexture.tga","DefaultAsset" };
		const AssetDef EmptySquare = { "Empty.tga","Empty" };
		const AssetDef XSquare = { "xsquare.tga","XSquare" };
		const AssetDef OSquare = { "osquare.tga","OSquare" };
		const AssetDef MainMenuBtn = { "MainMenuBtn.tga","MainMenuBtn", true };
		const AssetDef PlayerOneWins = { "Player1Wins.tga","PlayerOneWins", true };
		const AssetDef PlayerTwoWins = { "Player2Wins.tga","PlayerTwoWins", true };
		const AssetDef PlayersDraw = { "Draw.tga","PlayersDraw", true };
